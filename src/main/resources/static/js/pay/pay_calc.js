...
async function validateCalcRule(form) {
    ...
    const url = `${contextPath}/pay/rule_calc/checkPriority?itemCode=${itemCode}&priority=${priority}`
...
function bindEmpAutocomplete(input) {
    ...
    input.addEventListener("input", async (e) => {
        ...
        try {
            const res = await fetch(`${contextPath}/pay/rule_calc/searchEmployee?keyword=${encodeURIComponent(keyword)}`);
